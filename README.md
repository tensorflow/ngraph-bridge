...
Choose one of two ways to create your container:
  1. Use the `docker_build_and_run_ngtf.sh` script to do a multi-stage build and run nGraph for Ubuntu 18.04 in a single command. 
