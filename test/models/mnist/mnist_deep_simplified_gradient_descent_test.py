...
def deepnn(x, scope_suffix):
  ...
  """
    ...
    with tf.name_scope('conv1'):
        W_conv1 = weight_variable([5, 5, 1, 32], "W_conv1", scope_suffix)
    ...
    with tf.name_scope('conv2'):
        W_conv2 = weight_variable([5, 5, 32, 64], "W_conv2", scope_suffix)
    ...
    with tf.name_scope('fc1'):
        W_fc1 = weight_variable([7 * 7 * 64, 1024], "W_fc1", scope_suffix)
    ...
    with tf.name_scope('fc2'):
        W_fc2 = weight_variable([1024, 10], "W_fc2", scope_suffix)
...
def weight_variable(shape, name, scope_suffix):
    """weight_variable generates a weight variable of a given shape."""
    weight_var = tf.get_variable(name + "_" + scope_suffix, shape)
    return weight_var
...
def train_mnist_cnn(FLAGS, scope_suffix):
    # Config
    ...
    y_conv, keep_prob = deepnn(x, scope_suffix)
