...
'''
    ...
    If the directory you passed in already exists, this script will delete it and re-create it,
...
class TestTensorBoardNGraphStats(NgraphTest):
    ...
    def train_mnist_cnn(self):
        ...
        assert len(dirs) == 8 # 7 dirs, 1 TF event file generated by this script
