...
GetTFToNgOpMap() {
  ...
  static std::map<std::string, std::set<shared_ptr<ng::Node>>> TFtoNgraphOpMap {
    {"Abs", {std::make_shared<ngraph::op::Abs>()}},
        ...
        {"Any",
         {std::make_shared<ngraph::opset3::ReduceLogicalOr>()}},
        {"All",
         {std::make_shared<ngraph::opset3::ReduceLogicalAnd>()}},
        ...
        {"MatMul",
         {std::make_shared<ngraph::op::Reshape>(),
          std::make_shared<ngraph::op::MatMul>()}},
        {"Max", {std::make_shared<ngraph::opset3::Maximum>(), constant}},
        {"Maximum",
         {std::make_shared<ngraph::opset3::Maximum>()}},
        {"MaxPool",
         {std::make_shared<ngraph::op::Reshape>(),
        ...
        {"OneHot", {std::make_shared<ngraph::op::OneHot>()}},
        {"Pack",
         {std::make_shared<ngraph::op::Concat>(),
          std::make_shared<ngraph::op::Reshape>()}},
        ...
        {"PreventGradient", {}},
        {"Prod",
         {std::make_shared<ngraph::opset3::ReduceProd>(), constant}},
        ...
        {"Sum",
         {std::make_shared<ngraph::opset3::ReduceSum>(), constant}},
