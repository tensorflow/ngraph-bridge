...
GetTFToNgOpMap() {
  ...
  static std::map<std::string, std::set<shared_ptr<ng::Node>>> TFtoNgraphOpMap{
      ...
      {"DepthToSpace", {std::make_shared<ngraph::opset3::DepthToSpace>()}},
      ...
      {"Relu6", {std::make_shared<ngraph::opset3::Clamp>()}},
      ...
      {"Tile", {std::make_shared<ngraph::opset3::Tile>()}},
      {"TopKV2",
       {std::make_shared<ngraph::op::TopK>(),
        std::make_shared<ngraph::op::GetOutputElement>()}},
      {"Transpose", {std::make_shared<ngraph::opset3::Transpose>()}},
      {"Xdivy",
