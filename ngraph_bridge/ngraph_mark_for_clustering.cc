...
GetTFToNgOpMap() {
  ...
  static std::map<std::string, std::set<shared_ptr<ng::Node>>> TFtoNgraphOpMap {
    {"Abs", {std::make_shared<ngraph::op::Abs>()}},
        ...
        {"AddV2", {std::make_shared<ngraph::op::Add>(), std::make_shared<ngraph::op::Broadcast>(), std::make_shared<ngraph::op::Reshape>()}},
        {"Any", {std::make_shared<ngraph::op::Any>(), std::make_shared<ngraph::op::Broadcast>(), constant, std::make_shared<ngraph::op::Reshape>()}},
        {"All", {std::make_shared<ngraph::op::All>(), std::make_shared<ngraph::op::Broadcast>(), constant, std::make_shared<ngraph::op::Reshape>()}},
        ...
        {"DepthwiseConv2dNative",
         {std::make_shared<ngraph::op::Slice>(),
          ...
          std::make_shared<ngraph::op::Reshape>()}},
        {"Dequantize", {std::make_shared<ngraph::op::Dequantize>(), constant, std::make_shared<ngraph::op::Divide>(), std::make_shared<ngraph::op::Maximum>(), std::make_shared<ngraph::op::Abs>()}},
        ...
        {"FloorDiv", {std::make_shared<ngraph::op::Divide>(), std::make_shared<ngraph::op::Floor>(), std::make_shared<ngraph::op::Broadcast>()}},
        {"FloorMod",
        ...
        {"FusedBatchNormGrad",
         {constant, std::make_shared<ngraph::op::GetOutputElement>(),
          std::make_shared<ngraph::op::BatchNormTrainingBackprop>(), std::make_shared<ngraph::op::Reshape>()}},
        ...
        {"Maximum", {std::make_shared<ngraph::op::Maximum>(), std::make_shared<ngraph::op::Broadcast>()}},
        {"MaxPool",
         {std::make_shared<ngraph::op::Reshape>(),
        ...
        {"Minimum", {std::make_shared<ngraph::op::Minimum>(), std::make_shared<ngraph::op::Broadcast>()}},
        ...
        {"PreventGradient", {}},
        {"Prod", {std::make_shared<ngraph::op::Product>(), constant, std::make_shared<ngraph::op::Reshape>()}},
        ...
        {"Sum", {std::make_shared<ngraph::op::Sum>(), std::make_shared<ngraph::op::Reshape>(), constant}},
