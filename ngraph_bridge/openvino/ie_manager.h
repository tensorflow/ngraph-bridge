...
class IEManager {
 public:
  ...
  static void CreateBlob(InferenceEngine::TensorDesc &desc, InferenceEngine::Precision &precision, const void *data_ptr, size_t byte_size, InferenceEngine::MemoryBlob::Ptr &blob_ptr) {
      switch (precision) {
